<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="SborZayavok.Admin" %>
...
<body>
    <form id="form1" runat="server">
        <div style="height: 368px">
            <asp:Label ID="Label1" runat="server" Text="Авторизация Администратора"></asp:Label>
            <center>
            <br />
            <br />
            <asp:Login ID="Login1" runat="server" BackColor="#EFF3FB" BorderColor="#B5C7DE" BorderPadding="4" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#333333" OnAuthenticate="Login1_Authenticate" Width="390px">
                                ...
                                <table cellpadding="0" style="width:390px;">
                                    ...
                                    <tr>
                                        <td align="right" colspan="2">
                                            <asp:Button ID="LoginButton" runat="server" BackColor="White" BorderColor="#507CD1" BorderStyle="Solid" BorderWidth="1px" CommandName="Login" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#284E98" OnClick="Page_Load" Text="Выполнить вход" ValidationGroup="Login1" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
