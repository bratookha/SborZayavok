<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Master2TabVSE.aspx.cs" Inherits="SborZayavok.Master2TabVSE" %>
...
<body style="height: 767px">
    <form id="form1" runat="server">
        <div style="background-color: #F8F8FF; height: 767px;">
            <asp:Label ID="Label1" runat="server" Text="Страница Мастера №2 - Все заявки"></asp:Label>
            <br />
            <br />
