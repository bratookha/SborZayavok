<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Master1TabNEW.aspx.cs" Inherits="SborZayavok.Master1TabNEW" %>
...
<body style="height: 321px">
    <form id="form1" runat="server">
        <div style="background-color: #F8F8FF; height: 977px;">
            <asp:Label ID="Label1" runat="server" Text="Страница Мастера №1 - Новые заявки"></asp:Label>
            <br />
            <br />
            <asp:Label ID="Label2" runat="server" Text="Таблица новых заявок"></asp:Label>
            <br />
