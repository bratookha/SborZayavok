<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminTabNEW.aspx.cs" Inherits="SborZayavok.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div style="height: 662px; background-color: #F8F8FF;">
            ...
            <br />
            <br />
            <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" style="margin-top: 0px">
                <Columns>
            ...
            <br />
            <br />
            <asp:Label ID="Label3" runat="server" Text="Таблица новых заявок"></asp:Label>
            <br />
            <br />
            <asp:GridView ID="GridView2" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="НомерЗаявки,ДатаЗаявки,ФИО,ТабельныйНомер,НомерТелефона,ТипЗаявки,ОписаниеЗаявки" DataSourceID="SqlDataSource3">
                <Columns>
